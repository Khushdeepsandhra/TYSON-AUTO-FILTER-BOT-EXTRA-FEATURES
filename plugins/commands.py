...
async def start(client, message):
    if message.chat.type in ['group', 'supergroup']:
        ...
        await asyncio.sleep(2) # 😢 https://github.com/Tysonmovierulz/TYSON-AUTO-FILTER-BOT-EXTRA-FEATURES/blob/master/plugins/p_ttishow.py#L17 😬 wait a bit, before checking.
        ...
        btn = [
            [
                InlineKeyboardButton(
                    "🔥 𝐃𝐈𝐒𝐂𝐔𝐒𝐒𝐈𝐎𝐍 🔥", url=invite_link.invite_link
                )
            ]
        ]
